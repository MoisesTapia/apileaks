...
from utils.discovery_session import DiscoveryResult, status_code_class
...
class EndpointFuzzer:
    ...
    def __init__(self, http_client: HTTPRequestEngine, config: FuzzingConfig,
        ...
        self.soft_404_signature: tuple[int, int, int] | None = None
...
class ResponseDifference:
    ...
    new_json_fields: list[str] | None = None
...
class ParameterFuzzer:
    ...
    async def _fuzz_markers(
        ...
        baselines: dict[str, Response | None] = {}
    ...
    async def _boundary_test_parameter(self, endpoint: Endpoint, param_name: str,
        ...
        for _value_type, test_values in self.boundary_values.items():
    ...
    async def _get_baseline_response(self, endpoint: Endpoint) -> Response | None:
    ...
    @staticmethod
    def _primary_signal(diff: "ResponseDifference") -> str | None:
    ...
    @staticmethod
    def _serialize_headers(headers: dict[str, str] | None) -> str:
